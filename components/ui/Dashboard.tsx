...
const Dashboard = () => {
  return (
    <div className='flex flex-col items-center justify-center text-center'>
        <div>
            <button><Link href="/Campaign">[Start a campaign]</Link></button>
            <img src="https://ibb.co/5KdDMJ6" alt="" />
        </div>
        ...
        <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            ...
            <div className="flex items-center flex-wrap ">
              <button className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">Stake Now
